...
const eventName = 'Chúc Mừng ngày kỷ niệm  ';
const titleCard = 'Tặng vit yêu';
const contentCard = 'Chúc em yêu của anh tràn ngập niềm vui và những nụ cười. Mong điều đẹp nhất sẽ đến với em trong hôm nay và cả những ngày sau';
